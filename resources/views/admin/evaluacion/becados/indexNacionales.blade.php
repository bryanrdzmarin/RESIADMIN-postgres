<x-layouts.app >
    ...
    <div class="mb-5 flex justify-between items-center">
        ...
        <div class="flex gap-x-3 mr-8">
            <form action="{{ route('admin.evaluar.becados.showbecadosNacionalesEvaluacion') }}" method="GET">
     ...
     <flux:radio.group label="" variant="segmented" size="sm" class="w-fit mx-auto mb-4">
        ...
        <flux:radio value="disponibles" class="{{ request()->routeIs('admin.evaluar.becados.indexbecadosNacionalesEvaluacion') || request()->routeIs('admin.evaluar.becados.showbecadosNacionalesEvaluacion') ? 'bg-white text-black' : ''}}">
                    ...
                    <tr class="odd:bg-white even:bg-gray-100">
                        ...
                        <td class="border border-gray-300 px-4 py-2 text-center">
                            ...
                            @if(is_null($becado->evaluacion_final))
                                <form action="{{ route('admin.evaluar.becados.evaluarBecado', ['becado' => $becado->ci, 'origen' => 'nacionales']) }}" method="GET">
                        ...
                        <td class="border border-gray-300 px-4 py-2 text-center align-middle">
                            <div class="flex items-center justify-center">
                                <form action="{{ route('admin.evaluar.becados.editarEvaluacion', ['becado' => $becado->ci, 'origen' => 'nacionales']) }}" method="GET">
